...
State.find_or_create_by(name: 'Анализ целесообразности')
State.find_or_create_by(name: 'Покупка')
State.find_or_create_by(name: 'Ремонт')
State.find_or_create_by(name: 'Продажа')
State.find_or_create_by(name: 'Архив')